exports.command = {
	...
	execute: function(socket, command, command_access) {
		...
		if (typeof (w.registerTime) === 'undefined') {
			...
			command_access.sendData(socket, chalk.bold(":: ") + chalk.cyan(whom) + " was " + chalk.green("registered") + " at " + chalk.bold(command_access.getDateTimeString(w.registerTime)) + ".\r\n");
		}
		...
		if (typeof w.loginTime !== 'undefined') {
			command_access.sendData(socket, chalk.bold(":: ") + chalk.cyan(whom) + " last logged in at " + chalk.bold(command_access.getDateTimeString(w.loginTime)) + ".\r\n");
		}
